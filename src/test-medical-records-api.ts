...
async function testGetMedicalRecords() {
  ...
  try {
    ...
    const response = await apiClient.get(`/dental/patients/${testPatientId}/records`);
...
async function testGetMedicalRecordDetails() {
  ...
  try {
    ...
    const response = await apiClient.get(`/dental/records/${testMedicalRecordId}`);
...
async function testUpdateMedicalRecord() {
  ...
  try {
    ...
    const response = await apiClient.put(`/dental/records/${testMedicalRecordId}`, updatedMedicalRecord);
    ...
    // 验证更新结果
    const verifyResponse = await apiClient.get(`/dental/records/${testMedicalRecordId}`);
...
async function testDeleteMedicalRecord() {
  ...
  try {
    ...
    const response = await apiClient.delete(`/dental/records/${testMedicalRecordId}`);
